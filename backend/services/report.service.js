...
const generatePortfolioReport = async (portfolio, user, aiAnalysis = {}) => {
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.fill('white').fontSize(22).font('Helvetica-Bold').text('InvestIQ AI', 50, 25);
      ...
      doc.on('pageAdded', () => {
        doc.fill('#94a3b8').fontSize(7).font('Helvetica')
          .text(
            'Generated by InvestIQ AI · This report is for informational purposes only and not financial advice.',
